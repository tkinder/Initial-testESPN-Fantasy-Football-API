...
class Client {
  ...
  getHistoricalScoreboardForWeek({
    ...
    const route = this.constructor._buildRoute({
      base: `${this.leagueId}`,
      params:
        `?scoringPeriodId=${scoringPeriodId}&seasonId=${seasonId}` +
  ...
  getLeagueInfo({ seasonId }) {
    ...
    return axios.get(route, this._buildAxiosConfig()).then((response) => {
      ...
      return League.buildFromServer(data, {
        leagueId: this.leagueId,
        seasonId
      });
    });
...
const myClient = new Client({ leagueId: 592276 });

myClient.setCookies({
  espnS2:
    'AEBO1C8l6mJUadNU71seu1Gt71MEDLyP28kSwxFPUD0%2BRQ%2BaptgrvuDyT8N9aUaNrJNCE96GbV%2FuAIyH%2FnSVUiLLwvYIH%2BkH1HKyR9bSh7UaWnbV28YWCc%2FYajQE4dCA9mo2HrWJ7RYdhcUIJXnMVW%2BKWQnfp%2BO2jendpnfiwyAkZ4ULbiyCXaB3aOwfnlLyhipbBv7rJNo0Odr9WWHDfNv6FbqMq9hRbvdNDfre6DMDwYdTTNjs94OrksxYIde61%2BY%2F5Fp44n2kXqlaSPyE7enzdwyI%2FP4Ruh1oHrH%2BTASWfQ%3D%3D',
  SWID: '{5782955B-6A23-4EB2-9872-77F6FFDA2127}'
});
